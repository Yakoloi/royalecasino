...
var game = {
    ...
    playerChoices: function() {
        game.buttonChoice = "";
        $("#buttonView").html("");
        $("#buttonView").append("<button class='btn btn-md playerChoiceButtons' data-choice='hit' id='hit' type='button' class='btn btn-outline-primary'>Hit</button>");
        $("#buttonView").append("<button class='btn btn-md playerChoiceButtons' data-choice='stand' id='stand' type='button' class='btn btn-outline-primary'>Stand</button>");
...
var dealer = {
    ...
    updateDealerScore: function() {
        ...
        $("#dealerScore").html("");
        $("#dealerScore").html("Dealer score: " + dealer.dealerScore);
